---
slug: Documentación del Caso de Uso para la Redirección
title: Documentación del Caso de Uso para la Redirección
authors:
  - name: Luiggy Carlin
    title: Frontend Developer
    url: https://github.com/lgcarlinf
    image_url: https://avatars.githubusercontent.com/u/74381991?v=4
tags: [NGINX,SEO]
---

import CorporativeDiagram from '../src/components/CorporativeDiagram.tsx'
